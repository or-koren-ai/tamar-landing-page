              ...
              <div>
                ...
                <div className={`overflow-hidden transition-all duration-500 ease-out ${
                  ...
                  <div className={`mt-4 transition-all duration-500 ease-out ${
                    ...
                    <p className="mb-6 text-xl leading-relaxed text-right">
                      המרפאה הפרטית נמצאת בחיפה ומשרתת תושבים מכל אזור הצפון כולל קריית אתא, קריית מוצקין, קריית ביאליק, עמק יזרעאל, יוקנעם והסביבה. המרפאה מקבלת תורים פרטיים ומציעה זמינות גבוהה לטיפול דחוף במחלות עור.
                    </p>
                    <p className="mb-6 text-xl leading-relaxed text-right">
