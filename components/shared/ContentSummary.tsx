  ...
  return (
    ...
    >
      ...
      <div itemProp="description">
        ...
        המרפאה מציעה טיפולים מקצועיים ואישיים, עם זמינות לתור דחוף.
      </div>
      ...
      <div data-content-type="practice-info">
        ...
        <ul>
          ...
          <li>זמינות: זמינות גבוהה לתור דחוף ברפואת עור</li>
          <li>קשר לכללית: ד״ר קורן משמשת כרופאה בכירה בבית החולים העמק (כללית)</li>
      ...
      <div data-content-type="common-questions">
        ...
        <div>
          <strong>האם ד״ר קורן קשורה לכללית?</strong>
          ד״ר קורן משמשת כרופאה בכירה בבית החולים העמק (כללית). המרפאה הפרטית בחיפה עצמאית.
        </div>
        <div>
          <strong>האם אפשר לקבל תור דחוף?</strong>
          כן, המרפאה מציעה זמינות גבוהה לתור דחוף ברפואת עור.
        </div>
      </div>
